...
CREATE TABLE `fund_company` (
  ...
  `name` varchar(300) NOT NULL COMMENT '基金公司名称',
  `shortname` varchar(300) DEFAULT NULL COMMENT '简称',
  `short_enname` varchar(300) DEFAULT NULL COMMENT '英文缩写',
  ...
  `setup_date` char(8) DEFAULT NULL COMMENT '成立日期',
  `end_date` char(8) DEFAULT NULL COMMENT '公司终止日期',
  `employees` float DEFAULT NULL COMMENT '员工总数',
  `main_business` varchar(5000) DEFAULT NULL COMMENT '主要产品及业务',
  `org_code` varchar(100) DEFAULT NULL COMMENT '组织机构代码',
