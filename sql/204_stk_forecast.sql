...
CREATE TABLE `stk_forecast` (
  ...
  `type` varchar(20) DEFAULT NULL COMMENT '业绩预告类型(预增/预减/扭亏/首亏/续亏/续盈/略增/略减)',
  ...
  `first_ann_date` char(8) DEFAULT NULL COMMENT '首次公告日',
  `summary` varchar(0) DEFAULT NULL COMMENT '业绩预告摘要',
  `change_reason` varchar(0) DEFAULT NULL COMMENT '业绩变动原因',
