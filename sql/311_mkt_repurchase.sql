...
CREATE TABLE `mkt_repurchase` (
  ...
  `end_date` char(8) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT DEFAULT NULL COMMENT '截至日期',
  `proc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT DEFAULT NULL COMMENT '进度',
  `exp_date` char(8) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT DEFAULT NULL COMMENT '过期日期',
