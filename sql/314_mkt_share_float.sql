...
CREATE TABLE `mkt_share_float` (
  ...
  `holder_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '股东名称',
  `share_type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '股份类型',
  PRIMARY KEY (`id`),
