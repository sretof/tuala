...
CREATE TABLE `fund_div` (
  ...
  `imp_anndate` char(8) DEFAULT NULL COMMENT '分红实施公告日',
  `base_date` char(8) DEFAULT NULL COMMENT '分配收益基准日',
  `div_proc` varchar(50)  DEFAULT NULL COMMENT '方案进度',
  `record_date` char(8) DEFAULT NULL COMMENT '权益登记日',
  `ex_date` char(8) DEFAULT NULL COMMENT '除息日',
  `pay_date` char(8) DEFAULT NULL COMMENT '派息日',
  `earpay_date` char(8) DEFAULT NULL COMMENT '收益支付日',
  `net_ex_date` char(8) DEFAULT NULL COMMENT '净值除权日',
