...
#用户在使用时请修改成自己的账号和密码
thsLogin = THS_iFinDLogin("18027253082","879211Qa")
if(thsLogin == 0 or thsLogin == -201):
    ...
    thsDataDataPool  = THS_DataPool("index","2016-11-27;001005260","date:Y,security_name:Y,thscode:Y,weight:Y")
    ...
    for i in range(0,len(thsCodes)-1):
        ...
        thsDataHighFrequenceSequence = THS_HighFrequenceSequence(thsCodes[i],"open;high;low;close","CPS:0,MaxPoints:50000,Fill:Previous,Interval:1","2016-11-23 09:35:00","2016-11-23 09:35:00")
