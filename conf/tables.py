...
STKDAILYTABLES = {
    ...
    'stk_weekly': {'sdate': '19901219', 'tuapi': 'weekly', 'spm': True, 'dfield': 'trade_date', 'enable': True, 'loop': True, 'fields': ''},
    'stk_monthly': {'sdate': '19901219', 'tuapi': 'monthly', 'spm': True, 'dfield': 'trade_date', 'enable': True, 'loop': True,
                    'fields': ''},
    'stk_daily_basic': {'sdate': '19901219', 'tuapi': 'daily_basic', 'spm': False, 'dfield': 'trade_date', 'enable': True, 'loop': True, 'fields': ''},
...
BASICTABLES = {
    'stk_basic': {'params': ({'list_status': 'L'}, {'list_status': 'D'}, {'list_status': 'P'}), 'tuapi': 'daily', 'spm': False, 'enable': True, 'update': True,
                  'updfields': ('delist_date', 'list_status', 'name'),
