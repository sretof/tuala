...
# # 测试接口
# df = api.query(api_name='dividend',ts_code='600848.SH',fields='ann_date')
# # cols = df.columns
# # rowv = []
# # for col in cols:
# #     rowv.append(col)
...
# # print(len(df))
# # print(df)
# print('-->',df['ann_date'].isnull().value_counts())


# #删除dfield列为None的行
# df = api.query(api_name='express',ts_code='600848.SH',fields='ann_date')
# print(type(df['ann_date'].isnull().value_counts()))


#30
df = ts.pro_bar(api=api, ts_code='600848.SH', freq='5min', asset='E', start_date='20190619', end_date='20190622')
print(df)
